...
public class GridStepDefinitions {
    ...
    public void kullanici_medunna_sayfasina_gider() throws MalformedURLException {
        driver = new RemoteWebDriver(new URL("http://192.168.1.100:4444"), new ChromeOptions());
    ...
    public void kullanici_firefox_ile_medunna_sayfasina_gider() throws MalformedURLException {
        ...
        driver = new RemoteWebDriver(new URL("http://192.168.1.100:4444"), new EdgeOptions());
        driver.manage().window().maximize();
        driver.get("https://medunna.com/");
